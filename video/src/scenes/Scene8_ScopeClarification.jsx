...
/**
 * Scene 8 — Scope Clarification (10s)
 *
 * Full-frame dark layout. Two columns:
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 32, flex: 1 }}>
        ...
        >
          ...
          >
            <div style={{ fontSize: 20, fontWeight: 700, color: C.green500, marginBottom: 24 }}>
        ...
        >
          ...
          >
            <div style={{ fontSize: 20, fontWeight: 700, color: 'rgba(255,255,255,0.5)', marginBottom: 24 }}>
